...
const MidSection = () => {
  ...
  return (
    <div className="  pt-0 overflow-hidden">
      <div className="top-0 left-0 w-full  overflow-hidden p-0 m-0 relative">
        <CarouselBackground />
      </div>
          ...
          <div className="w-full max-w-4xl px-6">
            <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl p-10 md:p-14 text-center transform transition-transform duration-300 hover:scale-95">
              ...
              <p className="text-lg mb-6 text-gray-700">
                At FairlySettled, we treat your legal issues with the same care
                we give our own. Whether it’s family, criminal, civil,
                corporate, or cyber matters we focus on your long-term peace of
                mind. From negotiation and mediation to court representation, we
                help you choose the best legal path, not just the quickest. We
                don’t ask you to choose us we ask you to choose the right
                lawyer.
              </p>
            </div>
          </div>
