...
const MidSection = () => {
  ...
  return (
    <div className="px-4 bg-[#9db6d9bd] pt-15 md:px-20 overflow-hidden">
      ...
      {/* Infinite Moving Features Section */}
      {/* Infinite Moving Features Section */}
      
      {/* Infinite Moving Features Section */}
      <motion.section className="py-16 bg-white px-4 rounded-xl mt-10 overflow-hidden">
        ...
        >
          {[...features, ...features].map((item, idx) => (
            <div
              key={idx}
              className="w-[300px] shrink-0 bg-white/30 backdrop-blur-xl border border-white/40 shadow-2xl rounded-3xl p-6 cursor-pointer mx-2 hover:scale-105 transition duration-300"
              onClick={() =>
            ...
            >
              ...
              <button
                ...
                className="bg-[#3E3F5B] text-white px-4 py-1.5 rounded-full text-sm hover:bg-blue-500 transition mt-3"
              >
